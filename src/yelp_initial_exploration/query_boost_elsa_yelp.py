...
def main():
    ...
    ap.add_argument("--items_csv", type=Path, required=True, help="CSV with columns i,business_id,tag_str,name")
    ap.add_argument("--scores", type=Path, required=True, help=".npy or .csv (i,score)")
    ap.add_argument("--query", type=str, required=True)
    ap.add_argument("--alpha", type=float, default=0.7, help="weight for base ELSA score")
