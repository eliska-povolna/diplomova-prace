...
\def\ThesisTitle{Vysvětlitelné a upravitelné doporučování volnočasových aktivit}

% Název práce v angličtině
\def\ThesisTitleEN{Explainable and Steerable POI Recommendations}

% Jméno autora (vy)
\def\ThesisAuthor{Bc. Eliška Povolná}
...
\def\ThesisKeywords{%
doporučovací systémy\sep sparse autoencoders\sep POI
}

\def\ThesisKeywordsEN{
recommender systems\sep sparse autoencoders\sep POI
}
